...
var _reduxDevtoolsExtension = __webpack_require__(67);
...
var store = (0, _redux.createStore)(_index.reducer, (0, _reduxDevtoolsExtension.composeWithDevTools)((0, _redux.applyMiddleware)(_reduxThunk2.default)));
...
*/
var aa=__webpack_require__(2),ba=__webpack_require__(1),m=__webpack_require__(14),p=__webpack_require__(4),v=__webpack_require__(3),da=__webpack_require__(15),ea=__webpack_require__(16),fa=__webpack_require__(17),ha=__webpack_require__(6);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(20), __webpack_require__(48)(module)))
...
var _fetchingObjects = __webpack_require__(70);

var _paginationNumber = __webpack_require__(71);

var reducer = exports.reducer = (0, _redux.combineReducers)({
    items: _items.items,
    fetchingObjects: _fetchingObjects.fetchingObjects,
    paginationNumber: _paginationNumber.paginationNumber
});
...
var fetchingObjects = exports.fetchingObjects = function fetchingObjects() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    var action = arguments[1];

    switch (action.type) {
        case 'FETCHING_OBJECTS_START':
            return true;
        case 'FETCHING_OBJECTS_END':
            return false;
        default:
            return state;
    }
...
var paginationNumber = exports.paginationNumber = function paginationNumber() {
...
var Navigation = function (_React$Component) {
    ...
    function Navigation(props) {
        ...
        _this.breadcrumbs = function () {
            return _react2.default.createElement(
                'div',
                { className: 'd-flex breadcrumbs' },
                _react2.default.createElement(
                    'p',
                    null,
...
var _ObjectListContainer = __webpack_require__(76);

var _ObjectListContainer2 = _interopRequireDefault(_ObjectListContainer);

var _PaginationContainer = __webpack_require__(80);
    ...
    _createClass(MainSection, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_ObjectListContainer2.default, null),
...
var _ObjectList = __webpack_require__(77);
...
var mapStateToProps = function mapStateToProps(state) {
    ...
    var pagIdx = state.paginationNumber;
    var array = state.items.filter(function (item) {
        return item.index == pagIdx;
    });
    var items = array[0] ? array[0].items : [];
...
var ObjectListContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_ObjectList2.default);

exports.default = ObjectListContainer;
...
var _ObjectItem = __webpack_require__(78);

var _ObjectItem2 = _interopRequireDefault(_ObjectItem);

var _NoObjects = __webpack_require__(79);

var _NoObjects2 = _interopRequireDefault(_NoObjects);
...
var ObjectList = function (_React$Component) {
    _inherits(ObjectList, _React$Component);

    function ObjectList(props) {
        _classCallCheck(this, ObjectList);

        return _possibleConstructorReturn(this, (ObjectList.__proto__ || Object.getPrototypeOf(ObjectList)).call(this, props));
    }

    _createClass(ObjectList, [{
        key: 'render',
        value: function render() {
            var content = this.props.items && this.props.items.length > 0 ? this.props.items.map(function (item, idx) {
                return _react2.default.createElement(_ObjectItem2.default, { key: idx, item: item });
            }) : _react2.default.createElement(_NoObjects2.default, null);
...
var ObjectItem = function (_React$Component) {
    _inherits(ObjectItem, _React$Component);

    function ObjectItem(props) {
        _classCallCheck(this, ObjectItem);

        var _this = _possibleConstructorReturn(this, (ObjectItem.__proto__ || Object.getPrototypeOf(ObjectItem)).call(this, props));

        _this.image = function () {
            var id = 1 + Math.floor(Math.random() * 5.9);
            var img = _react2.default.createElement('img', { src: "./img/house/" + id + '.jpg', alt: '' });
            return _react2.default.createElement(
                'div',
        ...
        _this.description = function () {
            ...
            var id = item.id;
            var mkadDistance = item.postId;
            var locationName = item.name;
            var firstDescription = item.id % 2 == 0 ? 'Участток в поселке' : 'Дом в поселке';

            var finalDesc = firstDescription + ' ' + locationName + ', ' + mkadDistance + ' км' + ', ' + 'ID ' + id;
            return _react2.default.createElement(
                'div',
        ...
        _this.square = function () {
            ...
            var yardSquare = !item.postId ? null : item.postId + ' coт';
            var homeSquare = !item.id ? null : item.id + ' m';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement('img', { src: './img/garden.png' }),
                    yardSquare
                ),
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement('img', { src: './img/home.png' }),
                    homeSquare
                )
            );
        };
...
var NoObjects = function (_React$Component) {
    _inherits(NoObjects, _React$Component);

    function NoObjects(props) {
        _classCallCheck(this, NoObjects);

        return _possibleConstructorReturn(this, (NoObjects.__proto__ || Object.getPrototypeOf(NoObjects)).call(this, props));
    }

    _createClass(NoObjects, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
...
//there will be filtering
var arrayOfIndexes = function arrayOfIndexes(state) {
...
var mapStateToProps = function mapStateToProps(state) {
    return {
        ...
        arrayOfIndexes: arrayOfIndexes(state)
    };
};

var mergeProps = function mergeProps(stateProps, dispatchProps) {
    var paginationNumber = stateProps.paginationNumber,
        arrayOfIndexes = stateProps.arrayOfIndexes;
    var dispatch = dispatchProps.dispatch;


    var onPagClick = function onPagClick(index) {
        var needFetch = true;
        ...
        if (needFetch) {
            dispatch((0, _index.fetchItems)(index));
        } else {
            dispatch((0, _index.paginationNumber)(index));
        }
    };

    return {
        paginationNumber: paginationNumber,
        onPaginationClick: function onPaginationClick(index) {
            return onPagClick(index);
        }
    };
};

var PaginationContainer = (0, _reactRedux.connect)(mapStateToProps, null, mergeProps)(_Pagination2.default);
...
exports.fetchItems = exports.paginationNumber = undefined;
...
var addItems = function addItems(items, index) {
    return {
        type: 'ADD_ITEMS',
        items: items,
        index: index
...
var fetchingObjectsSrart = function fetchingObjectsSrart() {
    return {
        type: 'FETCHING_OBJECTS_START'
    };
};

var fetchingObjectsEnd = function fetchingObjectsEnd() {
    return {
        type: 'FETCHING_OBJECTS_END'
    };
};

var paginationNumber = exports.paginationNumber = function paginationNumber(index) {
    return {
...
var fetchItems = exports.fetchItems = function fetchItems(index) {

    var indexOffset = index - 1;

    return function (dispatch) {

        dispatch(fetchingObjectsSrart());

        var path = _config2.default.fetchUrl + '?_start=' + indexOffset * 32 + '&_limit=' + 32;
        var options = {
            method: 'GET'
        };
        ...
        return fetch(path, options).then(function (response) {
            ...
            dispatch(addItems(items, index));
            dispatch(fetchingObjectsEnd());
            dispatch(paginationNumber(index));
        });
    };
};
...
module.exports = {"fetchUrl":"https://jsonplaceholder.typicode.com/comments"}
...
var Pagination = function (_React$Component) {
    ...
    function Pagination(props) {
        ...
        _this.handleOnClick = function (pageNumber) {
            window.scrollTo(0, 0);
            _this.props.onPaginationClick(pageNumber);
        };

        _this.controlBtns = function () {
            var curNumber = _this.props.paginationNumber;
            var prevBtn = curNumber != 1 ? _react2.default.createElement(
                'button',
                { className: 'btn btn-main', onClick: function onClick() {
                        return _this.handleOnClick(curNumber - 1);
                    } },
                '\u041F\u0440\u0435\u0434\u044B\u0434\u0443\u0449\u0430\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430'
            ) : null;
            return _react2.default.createElement(
        ...
        _this.pages = function () {
            var currentPage = _this.props.paginationNumber;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'li',
                        { className: 'active-page', onClick: function onClick() {
                                return _this.handleOnClick(currentPage);
                            } },
                        currentPage
                    ),
                    _react2.default.createElement(
                        ...
                        { onClick: function onClick() {
                                return _this.handleOnClick(currentPage + 1);
                            } },
                        currentPage + 1
                    ),
                    _react2.default.createElement(
                        'li',
                        { onClick: function onClick() {
                                return _this.handleOnClick(currentPage + 2);
                            } },
                        currentPage + 2
                    ),
                    _react2.default.createElement(
                        'li',
                        { onClick: function onClick() {
                                return _this.handleOnClick(currentPage + 3);
                            } },
                        currentPage + 3
                    )
                )
...
Pagination.propTypes = {
    paginationNumber: _propTypes2.default.number,
    onPaginationClick: _propTypes2.default.func
};
